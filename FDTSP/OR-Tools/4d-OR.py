...
############################## COMBINATION BETWEEN TRUCK AND DRONES BEGIN ###########################
    ...
    zipped2 = zip(list_trucks_new, list_dr1_new,list_dr2_new,list_dr3_new,list_dr4_new)
    ...
    SL1 = sum(count_clusters)  #number of points cannot be served due to exceeding 4 hours    
    ...
    SL2 = no_service_by_dr1 + no_service_by_dr2 + no_service_by_dr3 + no_service_by_dr4
    SL = SL1+SL2    
...
############################### PERFORMING EVALUATION #############################################    
    ...
    count_deli=count_deli1+count_deli2+count_deli3+count_deli4
    dd = count_deli/n
    ...
    count_drones_used_in_fact = count_drone1_used_in_fact + count_drone2_used_in_fact + count_drone3_used_in_fact+count_drone4_used_in_fact
    ...
    count_total = count_dr1+count_dr2+count_dr3+count_dr4
############################## RESULTS RECORDING #############################################    
    headers = ['INSTANCES', 
...
df = pd.DataFrame(result_final, columns = ['INSTANCES', 
                                           ...
                                           'NUMBER OF POINTS CANNOT BE SERVED BY TRUCK-TSP ONLY WITHIN 4 HOURS',
                                           'NUMBER OF DRONE-POINTS  BE REPLACED BY TRUCK'])
df.to_csv (r'4DRONES-Ortool.csv', index = False, header=True)
